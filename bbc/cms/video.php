  ...
  <div id="content-wrapper" class="d-flex flex-column">
    ...
    <div id="content">
      ...
      <div class="container-fluid">
        <?php flash(); ?>
        <!-- Page Heading -->
        <h1 class="h3 mb-4 text-gray-800">Video List
          <a href="video-form.php" class="btn btn-sm btn-success float-right">
            <i class="fa fa-plus"> Add Video</i>
          </a>
        </h1>
        <hr>
        <div class="row">
              ...
              <tbody>
                ...
                ?>
                    <tr>
                      ...
                      <td>
                          <iframe width="" height="" src="https://www.youtube.com/embed/<?php echo $cat_info->video_id;?>" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                        </td>
                      <td>
                      ...
                      <td>
                        <a href="video-form.php?id=<?php echo $cat_info->id; ?>" class="btn btn-success btn-sm" style="border-radius: 50%;">
                          <i class="fa fa-edit"></i>
                        </a>
                        <a href="process/video.php?id=<?php echo $cat_info->id; ?>" onclick="return confirm('Are you sure you want to delete this video?');" class="btn btn-danger btn-sm" style="border-radius: 50%;">
